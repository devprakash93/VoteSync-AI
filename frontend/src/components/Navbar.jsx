...
import { Vote, LogOut, User as UserIcon, ShieldCheck } from 'lucide-react';
        ...
        <div className="flex items-center gap-6">
          {user ? (
            <>
              ...
              <Link to="/verify" className="text-sm font-medium hover:text-primary transition-colors flex items-center gap-1">
